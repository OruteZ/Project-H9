...
public class PlayerPortraitUI : UIElement
{
    ...
    public void SetPortraitUI() 
    {
        ...
        Sprite enemySpr = Sprite.Create(playerTexture, new Rect(0, 0, playerTexture.width, playerTexture.height), new Vector2(0.5f, 0.5f));
        if (enemySpr == null) enemySpr = _defaultPlayerImage;
        transform.GetChild(0).GetComponent<Image>().sprite = enemySpr;
    }
